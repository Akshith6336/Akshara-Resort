...
<html>
<head>
<title>Akshara Resort | login page</title>
...
<body style="background-image : url(images//bg1.jpg) ; background-size : 100% 100%">
   ...
   <!--/content-inner-->
	...
	<div class="left-content" >
	   <div class="inner-content" >
			...
			<div class="content">
				<h3 style="color: red;font-family: cursive;">Akshara Resort</h3>
...
<div class="registration">
	...
	<div class="col-md-6">
						<img src="images/adminlogin.jpg" style="margin-top:20px ; height : 350px ; width : 100% ; border : 2px inset black" >
						</div>
