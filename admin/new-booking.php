...
<html>
<head>
<title>Akshara Resort | New Booking</title>
...
$sql="SELECT tbluser.*,tblbooking.BookingNumber,tblbooking.Status,tblbooking.BookingDate from tblbooking join tbluser on tblbooking.UserID=tbluser.ID where tblbooking.Status is null LIMIT $offset, $no_of_records_per_page";
